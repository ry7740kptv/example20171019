...
#define SPEAKER_SIZ_CONFIG_DESC                       121
#define SPEAKER_SIZ_INTERFACE_DESC_SIZE               9

#define SPEAKER_SIZ_STRING_LANGID                     4
#define SPEAKER_SIZ_STRING_VENDOR                     20
#define SPEAKER_SIZ_STRING_PRODUCT                    14
#define SPEAKER_SIZ_STRING_SERIAL                     26
